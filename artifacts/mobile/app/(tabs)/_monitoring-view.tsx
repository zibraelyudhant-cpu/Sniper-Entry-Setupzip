    ...
    >
      ...
      {logs.length === 0 ? (
        <View style={s.emptyBox}>
          ...
          <Text style={[s.emptySub, { color: colors.mutedForeground }]}>
            Sinyal dari semua menu (Sniper Breakout, Scalping) yang harga entry-nya sudah kehit akan otomatis muncul di sini untuk dipantau.
          </Text>
          <Pressable
            onPress={onRefresh}
            style={{
